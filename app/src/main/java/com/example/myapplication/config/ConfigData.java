...
public class ConfigData {
    ...
    /*退出登录时，要把isLogged与userNumLogged都修改*/
    ...
    // 当前已登录的用户ID
    public static int UserNumLogged;
    public static String UserNumLoggedName = "UserNumLogged";
    ...
    // 获得NumLogged值
    public static int getUserNumLogged() {
        SharedPreferences preferences = MyApplication.getContext().getSharedPreferences(SharedDataName, Context.MODE_PRIVATE);
        UserNumLogged = preferences.getInt(UserNumLoggedName, 0);
        return UserNumLogged;
    }

    // 设置userNumLogged值
    public static void setUserNumLogged(int userNumLogged) {
        SharedPreferences.Editor editor = MyApplication.getContext().getSharedPreferences(SharedDataName, Context.MODE_PRIVATE).edit();
        editor.putInt(UserNumLoggedName, userNumLogged);
        editor.apply();
    }
    ...
    /*public static int getNotifyLearnMode() {
        SharedPreferences preferences = LitePalApplication.getContext().getSharedPreferences(SharedDataName, Context.MODE_PRIVATE);
